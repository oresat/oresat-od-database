...
SOLAR_MODULE_5_OD = ALL_ODS[NodeId.SOLAR_MODULE_5]
SOLAR_MODULE_6_OD = ALL_ODS[NodeId.SOLAR_MODULE_6]
IMU_OD = ALL_ODS[NodeId.IMU]
REACTION_WHEEL_1_OD = ALL_ODS[NodeId.REACTION_WHEEL_1]
REACTION_WHEEL_2_OD = ALL_ODS[NodeId.REACTION_WHEEL_2]
REACTION_WHEEL_3_OD = ALL_ODS[NodeId.REACTION_WHEEL_3]
REACTION_WHEEL_4_OD = ALL_ODS[NodeId.REACTION_WHEEL_4]
GPS_OD = ALL_ODS[NodeId.GPS]
STAR_TRACKER_1_OD = ALL_ODS[NodeId.STAR_TRACKER_1]
DXWIFI_OD = ALL_ODS[NodeId.DXWIFI]
CFC_OD = ALL_ODS[NodeId.CFC]
