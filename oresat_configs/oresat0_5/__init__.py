...
_oresat0_5_json_dir = f"{_file_path}/jsons"

_fw_core_config = read_json_od_config(f"{_oresat0_5_json_dir}/fw_core.json")
...
SOLAR_MODULE_5_OD = make_od(_solar_config, NodeId.SOLAR_MODULE_5, _fw_core_config)
SOLAR_MODULE_6_OD = make_od(_solar_config, NodeId.SOLAR_MODULE_6, _fw_core_config)
...
REACTION_WHEEL_1_OD = make_od(_rw_config, NodeId.REACTION_WHEEL_1, _fw_core_config)
REACTION_WHEEL_2_OD = make_od(_rw_config, NodeId.REACTION_WHEEL_2, _fw_core_config)
REACTION_WHEEL_3_OD = make_od(_rw_config, NodeId.REACTION_WHEEL_3, _fw_core_config)
REACTION_WHEEL_4_OD = make_od(_rw_config, NodeId.REACTION_WHEEL_4, _fw_core_config)
